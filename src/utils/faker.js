...
const fakers = {
  ...
  fakePhotos() {
    const photos = [];
    for (let i = 0; i < 15; i++) {
      const imagePath = "/src/assets/images/profile-" + _.random(1, 15) + ".jpg";
      if (imageAssets[imagePath]) {
        photos.push(imageAssets[imagePath]); // No `.default`
      }
    }
  ...
  fakeImages() {
    const images = [];
    for (let i = 0; i < 15; i++) {
      const imagePath = "/src/assets/images/preview-" + _.random(1, 15) + ".jpg";
      if (imageAssets[imagePath]) {
        images.push(imageAssets[imagePath]); // No `.default`
      }
    }
